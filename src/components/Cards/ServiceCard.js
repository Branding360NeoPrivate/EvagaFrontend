  ...
  return (
    <div className="w-full grid grid-cols-1 lg:grid-cols-4 gap-4 border-borderSecondary border-2 rounded-md rounded-l-lg">
      ...
      <div className="py-2 px-1 pr-4 flex items-end justify-between flex-col">
        <span className="flex items-center justify-center gap-4">
          <p className="text-textGray">{subCategory ? subCategory : "Photography"}</p>
          <button className="border-2  rounded-full p-1 border-textGray" onClick={()=>history(`${internalRoutes.vendorEditservice}/${serviceId}`)}>
